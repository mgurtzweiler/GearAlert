...
namespace GearAlert.Infrastructure.Search {
    ...
    public class SearchService {
        ...
        public SearchService(ISearchConfiguration configuration) {
            IndexDirectory = configuration.IndexDirectory;
        }
        ...
        public IList<string> WhichQueriesMatchSingleItem(IndexItem item, IEnumerable<string> queries) {
            Directory directory = null;
            IndexWriter indexWriter = null;
            Analyzer analyzer = null;
            IndexReader reader = null;
        ...
        public IEnumerable<IndexItem> QueryIndex<T>(string searchQuery) {
            try {
                FSDirectory directory = FSDirectory.Open(new System.IO.DirectoryInfo(IndexDirectory));
